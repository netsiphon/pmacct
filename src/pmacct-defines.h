...
#define UBERLARGEBUFLEN (16384+MOREBUFSZ)
...
<<<<<<< HEAD
#define COUNT_INT_PACKET_PAYLOAD	0x0002000000100000ULL
#define COUNT_INT_PACKET_HEADER		0x0002000000200000ULL
#define COUNT_INT_UNIQUE_PACKET		0x0002000000400000ULL
#define COUNT_INT_CUSTOM_PRIMITIVES     0x0002000001000000ULL
=======
...
<<<<<<< HEAD
#define COUNT_PACKET_PAYLOAD            (COUNT_INT_PACKET_PAYLOAD & COUNT_REGISTRY_MASK)
#define COUNT_PACKET_HEADER             (COUNT_INT_PACKET_HEADER & COUNT_REGISTRY_MASK)
#define COUNT_UNIQUE_PACKET             (COUNT_INT_UNIQUE_PACKET & COUNT_REGISTRY_MASK)
=======
